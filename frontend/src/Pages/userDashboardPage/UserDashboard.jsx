...
export const UserDashboard = ({
    ...
    const gridTemplateColumns = '120px minmax(300px, 2fr) 140px 120px 140px minmax(200px, 1fr)';
    ...
    return (
        <div className="flex flex-col gap-6 h-full  p-2 sm:p-4">
            <DashboardHeader
            ...
            <div className="flex flex-col gap-3 flex-1 min-h-0">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <h3 className="text-white text md sm:text-lg font-semibold">My Requests</h3>
